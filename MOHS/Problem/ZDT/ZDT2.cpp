...
ZDT2::ZDT2(const char *path, HS_Params *hsParams,
...
double ZDT2::paretoOrdinate(double f1) {
    return 1 - pow(f1, 2);
}

void ZDT2::evaluate(Solution *sol) {
...
double ZDT2::getMaxDistance() const {

}

const char *ZDT2::getName() {
    return "ZDT2";
}
