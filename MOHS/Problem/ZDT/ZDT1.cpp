...
ZDT1::ZDT1(const char *path, HS_Params *hsParams,
...
double ZDT1::paretoOrdinate(double f1) {
    return 1 - sqrt(f1);
}

void ZDT1::evaluate(Solution *sol) {
...
double ZDT1::getMaxDistance() const {
    
}

const char *ZDT1::getName() {
    return "ZDT1";
}
