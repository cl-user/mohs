...
#ifndef REALMODALMEMORY_H
#define	REALMODALMEMORY_H

#include "HS_Structures/Memory/ModalMemory.h"

class RealModalMemory : public ModalMemory {
private:
...
public:
    /** Constructor */
    RealModalMemory(int size, Problem *problem);

    /** Destructor */
    virtual ~RealModalMemory();
