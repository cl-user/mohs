...
#ifndef REALVARIABLEBUILDER_H
#define	REALVARIABLEBUILDER_H

#include "VariableBuilder/VariableBuilder.h"

class RealVariableBuilder : public VariableBuilder {
public:
    RealVariableBuilder();
    virtual ~RealVariableBuilder();

    Variable *createVariable(double value);
